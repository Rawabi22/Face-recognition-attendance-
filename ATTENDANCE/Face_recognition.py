...
url = "http://192.168.8.142:81/stream"
res = requests.get(url, stream=True)
images = []
classNames = []
classSID = []
studentInfo = {441500200: 'Ellon musk', 431500200: 'Mohammad',
            341500200: 'Usain bolt'}

if 'Attendance.csv' in os.listdir(os.path.join(os.getcwd(), 'ATTENDANCE1')):
    print("there iss..")
